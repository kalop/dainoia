    ...
    <div className="content">
      ...
      <div className="row">
                ...
                <table className="table text-nowrap table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="badge bg-soft-warning">Clothing</span>
                      </td>
                      <td>
                        <div className="avatar-list-stacked">
                          <span className="avatar avatar-sm avatar-rounded">
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="badge bg-soft-dark">Electronics</span>
                      </td>
                      <td>
                        <div className="avatar-list-stacked">
                          <span className="avatar avatar-sm avatar-rounded">
        ...
        <div className="col-xl-6">
          <div className="card">
            <div className="card-header justify-content-between">
              <div className="card-title">Hoverable rows With striped rows</div>
            </div>
            <div className="card-body">
              <div className="table-responsive">
                ...
                <table className="table text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Manufacturer</td>
                      <td>
                        <span className="badge bg-soft-primary">Team Lead</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="badge bg-soft-warning">Director</span>
                      </td>
